...
========================================================================================
	Change Log:
1.9.1 (05-Jan-2023)
	- This plugin became a VIP CORE module, thanks Silver!
...
#define VIP_FEATURE			"L4d2_VomitjarShove"
...
public void OnPluginStart()
{
	...
	AutoExecConfig(true,			"l4d2_vomitjar_shove", "vip");
...
void Event_EntityShoved(Event event, const char[] name, bool dontBroadcast)
{
	...
	if( infected || witch )
	{
		...
		if(VIP_IsClientFeatureUse(client, VIP_FEATURE)) 
		{
